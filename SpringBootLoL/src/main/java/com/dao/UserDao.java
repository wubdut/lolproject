...
public class UserDao {
  ...
  public int contains(String username) {
	  ...
	  return entityManager.createQuery(
		        "from User where register.username = :username")
   ...
   */
  public User getByRegister(Register register) {
    return (User) entityManager.createQuery(
        "from User where register = :register")
  ...
  public List<User> getByName(String name) {
    return (List<User>) entityManager.createQuery(
        "from User where register.name like :name")
